...
export class Courses extends Component {
    ...
    showBuyPopup = (course) => {this.setState({isBuyPopupShown: true, isDescriptionPopupShown: false, buyPopupCourse: course})}
                                ...
                                <Fragment>
                                    <div className="course-locked-warning">
                                        ...
                                        <div className="locked-warning-controls">
                                            <button onClick={() => this.showBuyPopup(course)} className="locked-warning-controls-buy hover-animation">Купить</button>
