        ...
        return (
            <Fragment>
                <div className="content-header">
                    <h2 className="content-title">Курс: {this.props.course.name} <span className="gray">|</span> Неделя {this.props.location.state.week.number} <span className="gray">|</span> День {this.props.location.state.day.number}</h2>
